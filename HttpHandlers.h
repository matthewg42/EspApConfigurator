...
const char HTTP_FORM_START[] PROGMEM      = "<button id='r' onclick='r();'>Re-scan WiFi</button><form method='post' action='save'><h3>Wifi Settings</h3><p><label for='s'>SSID</label><input id='s' name='s' length=32><label for='p'>Passphrase</label><input id='p' name='p' length=64 type='password'></p>";
